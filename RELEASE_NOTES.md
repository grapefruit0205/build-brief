...
- The deterministic evidence-reuse benchmark exercises 500 controlled matrix
  cases across Python, Node.js, C, and Java while keeping semantic oracle,
  manifest variants, runtime observations, decisions, and shadow reruns
  separate.
